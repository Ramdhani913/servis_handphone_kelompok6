<?php $__env->startSection('content'); ?>
    <div class="page-heading">
        ...
        <section id="multiple-column-form">
            <form class="form" action="<?php echo e(route('services.store')); ?>" method="POST" data-parsley-validate id="form-add-service">
                <?php echo csrf_field(); ?>
                                        ...
                                        <div class="col-md-6 col-12">
                                            ...
                                            <div class="form-group mb-3">
                                                ...
                                                <select class="form-control" name="handphone" data-parsley-required="true" id="handphone">
                                                    ...
                                                    <?php $__currentLoopData = $handphones; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $handphone): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                        <option value="<?php echo e($handphone->id); ?>"><?php echo e($handphone->brand); ?> | <?php echo e($handphone->model); ?></option>
                                                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                                </select>
                                            </div>
                                        </div>
...
<script>
    var serviceItems = <?php echo json_encode($serviceItems); ?>;
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\rendr\Desktop\desktop\service_hp_aseli\resources\views\pages\Service\create.blade.php ENDPATH**/ ?>