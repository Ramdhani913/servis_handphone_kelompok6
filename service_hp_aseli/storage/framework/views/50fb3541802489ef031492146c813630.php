        ...
        <div class="card">
            <div class="card-body">
                <div class="d-flex justify-content-between align-items-center mb-4 flex-wrap">
                    ...
                    <a href="<?php echo e(route('users.create')); ?>" class="btn btn-tambah mt-2 mt-md-0">
                ...
                <div id="userTable">
                    <?php echo $__env->make('pages.maindata.user.table', ['users' => $users], array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
                </div>
    ...
    <script>
        ...
        $(document).ready(function() { // ✅ diperbaiki dari readay → ready
            ...
            $(document).on('click', '.status-toggle', function() {
                ...
                $.ajax({
                    url: "<?php echo e(url('users')); ?>/" + id + "/toggle-status",
                    type: 'POST',
                    data: {
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\rendr\Desktop\desktop\service_hp_aseli\resources\views\pages\maindata\user\index.blade.php ENDPATH**/ ?>