...
<div class="container mt-4" style="max-width:900px;">
    ...
    <div class="card shadow p-4 mb-4" style="background-color:#1e1e2d; color:#fff; border:none;">
        ...
        <div class="row">
            <div class="col-md-6">
                <p><strong>Estimated Cost:</strong> Rp <?php echo e(number_format($service->estimated_cost, 0, ',', '.')); ?></p>
                <p><strong>Other Cost:</strong>
                    <span id="other-cost" contenteditable="true"
                        ...
                        <?php echo e(number_format($service->other_cost ?? 0, 0, ',', '.')); ?>

                    </span>
                </p>
                <p><strong>Total Cost:</strong>
                    <span id="total-cost">Rp <?php echo e(number_format($service->total_cost, 0, ',', '.')); ?></span>
                </p>
            </div>
            <div class="col-md-6">
                <p><strong>Paid:</strong> 
                    <span id="paid-display">Rp <?php echo e(number_format($service->paid ?? 0, 0, ',', '.')); ?></span>
                </p>
                <p><strong>Change:</strong> 
                    <span id="change-display">Rp <?php echo e(number_format($service->change ?? 0, 0, ',', '.')); ?></span>
                </p>
                <?php
                    $remaining = max(0, $service->total_cost - $service->paid);
                ?>
                <p><strong>Remaining:</strong>
                    <span id="remaining-display" style="color:#00ffcc;">Rp <?php echo e(number_format($remaining, 0, ',', '.')); ?></span>
                </p>
    ...
    <div class="card shadow p-4" style="background-color:#1e1e2d; color:#fff; border:none;">
        ...
        <form action="<?php echo e(url('/services/pay/' . $service->id)); ?>" method="POST">
            <?php echo csrf_field(); ?>
            ...
            <div class="mb-3">
                ...
                <select name="payment_method" class="form-select" style="background:#2c2c3e; color:#fff; border:none;">
                    <option value="1" <?php echo e($service->payment_method == 1 ? 'selected' : ''); ?>>Cash</option>
                    <option value="2" <?php echo e($service->payment_method == 2 ? 'selected' : ''); ?>>Transfer</option>
                </select>
            </div>
...
document.getElementById('other-cost').addEventListener('blur', function() {
    const id = "<?php echo e($service->id); ?>";
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\rendr\Desktop\desktop\service_hp_aseli\resources\views\pages\Service\payment\index.blade.php ENDPATH**/ ?>