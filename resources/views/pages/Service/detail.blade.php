...
<div class="content-wrapper">
  ...
  <div class="card p-4 mb-4">
    ...
    <div class="card-body">
      <div class="info-item"><span class="info-label">Invoice</span><span class="info-value">{{ $service->no_invoice }}</span></div>
      <div class="info-item"><span class="info-label">Customer</span><span class="info-value">{{ $service->customer->name ?? '-' }}</span></div>
      <div class="info-item"><span class="info-label">Technician</span><span class="info-value">{{ $service->technician->name ?? '-' }}</span></div>
      <div class="info-item"><span class="info-label">Received Date</span>
        <span class="info-value">{{ $service->received_date ? $service->received_date->format('Y-m-d H:i') : '-' }}</span>
      </div>
      <div class="info-item"><span class="info-label">Handphone</span>
        <span class="info-value">{{ $service->handphones->brand ?? '-' }} {{ $service->handphones->model ?? '' }}</span>
      </div>
    </div>
  </div>
  ...
  <div class="card p-4">
    ...
    <div class="card-body">
      ...
      <a href="{{ route('services.index') }}" class="btn-back">← Kembali</a>
    </div>
  </div>
</div>
